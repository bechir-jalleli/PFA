...
import {
  ...
  PhoneOutlined, ClockCircleOutlined, BulbOutlined, EyeOutlined
  ...
  return (
    <Card style={styles.responsableCard} hoverable>
      ...
      <Row gutter={[16, 16]}>
        <Col span={12}>
          <Statistic
            title={<span style={styles.statTitle}>Chef Projects</span>}
            value={responsable.chefProjects.length}
            prefix={<ProjectOutlined style={{ color: isDarkMode ? '#81b1ff' : '#2196F3' }} />}
            valueStyle={styles.statValue}
          />
        </Col>
        <Col span={12}>
          <Statistic
            title={<span style={styles.statTitle}>Projects</span>}
      ...
      <Descriptions column={1} size="small">
        ...
        <Descriptions.Item 
          ...
          style={styles.text}
        >
          {new Date(responsable.lastLogin).toLocaleString()}
        </Descriptions.Item>
      </Descriptions>
          ...
          <Row gutter={[24, 24]}>
                ...
                <Row gutter={[24, 24]} style={{ padding: '24px' }}>
                  <Col xs={24} sm={8}>
                    <StatsCard
                      ...
                      value={organisation.chiffreAffaire}
                      suffix="€"
                      icon={<DollarOutlined />}
                  ...
                  <Col xs={24} sm={8}>
                    <StatsCard
                      ...
                      value={organisation.responsable.projects.length + 
                             organisation.responsable.chefProjects.length}
                  ...
                  <Col xs={24} sm={8}>
                    <StatsCard
                      ...
                      value={organisation.SousOrganisation.length}
                      icon={<TeamOutlined />}
                      isDarkMode={isDarkMode}
                    />
                  </Col>
            ...
            <Col xs={24} lg={8}>
              <ResponsableCard
                ...
                onViewProfile={handleResponsableClick}
                isDarkMode={isDarkMode}
              />
            </Col>
            ...
            <Col xs={24} lg={16}>
              <Card 
                title={<Title level={4} style={styles.text}>Organisation Details</Title>}
              ...
              >
                ...
                {organisation.SousOrganisation.length > 0 && (
                  <>
                    <Title level={4} style={{ ...styles.text, marginTop: '24px' }}>
                      Sous Organisations
                    </Title>
                    <Row gutter={[16, 16]}>
                      {organisation.SousOrganisation.map((sousOrg, index) => (
                        <Col xs={24} sm={12} key={index}>
                          <Card 
                            size="small"
                            style={{ ...styles.mainCard, background: isDarkMode ? '#3d3d3d' : '#ffffff' }}
                          >
                            <Text strong style={styles.text}>{sousOrg.title}</Text>
